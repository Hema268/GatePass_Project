//src/components/GatepassForm/MaterialInPassForm.js
import React, { useRef, useState } from 'react';
import Webcam from 'react-webcam';
import axios from 'axios';

function MaterialInPassForm() {
  const [formData, setFormData] = useState({
    type: 'Material-In Pass',
    date: '',
    nameOfCompany: '',
    vehicle: '',
    contact: '',
  ...
  const [tableData, setTableData] = useState([{ description: '', quantity: '', billNo: '', billDate: '' }]);
  ...
  const addTableRow = () => {
    setTableData([...tableData, { description: '', quantity: '', billNo: '', billDate: '' }]);
  };
  ...
  const printGatepass = () => {
    ...
    if (!printWindow) {
      alert('Unable to open print window. Please check your browser\'s pop-up blocker settings.');
      return;
    }
          ...
          <style>
            @media print {
              ...
              .fields-column {
                ...
                gap: 5px;
                border-right: 2px solid black; /* Vertical line between fields and photo */
                padding-right: 10px;
              }
              .photo {
                width: 200px;
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <h2>Material Inward Gate Pass</h2>
            </div>
...
export default MaterialInPassForm;
